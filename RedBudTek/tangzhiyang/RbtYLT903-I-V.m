...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [backGroungView setImage:[UIImage imageNamed:@"903-I-VBG"]];
        [self addSubview:backGroungView];
        
        imageView_P2 = [[UIImageView alloc] initWithFrame:CGRectMake(252, 349, 27, 27)];
        ...
        imageView_EH4 = [[UIImageView alloc] initWithFrame:CGRectMake(210, 97, 27, 27)];
        ...
        imageView_paiqifa = [[UIImageView alloc] initWithFrame:CGRectMake(232, 197, 27, 27)];
        [imageView_paiqifa setImage:[UIImage imageNamed:@"paiqifa_on"]];
        [self addSubview:imageView_paiqifa];
        
        imageView_EH3 = [[UIImageView alloc] initWithFrame:CGRectMake(149, 97, 27, 27)];
        ...
        imageView_T3 = [[UIImageView alloc] initWithFrame:CGRectMake(132, 139, 57, 57)];
        [imageView_T3 setImage:[UIImage imageNamed:@"jireqi"]];
        [self addSubview:imageView_T3];
        
        imageView_T2 = [[UIImageView alloc] initWithFrame:CGRectMake(110, 222, 100, 100)];
        [imageView_T2 setImage:[UIImage imageNamed:@"shuixiang1"]];
        [self addSubview:imageView_T2];
        
        imageView_T5 = [[UIImageView alloc] initWithFrame:CGRectMake(132, 403, 57, 57)];
        [imageView_T5 setImage:[UIImage imageNamed:@"linyuqi"]];
        [self addSubview:imageView_T5];
        
        imageView_E1 = [[UIImageView alloc] initWithFrame:CGRectMake(84, 97, 27, 27)];
        ...
        imageView_X = [[UIImageView alloc] initWithFrame:CGRectMake(70, 246, 27, 27)];
        [imageView_X setImage:[UIImage imageNamed:@"EH2_on"]];
        [self addSubview:imageView_X];
        
        imageView_zengyabeng = [[UIImageView alloc] initWithFrame:CGRectMake(81, 419, 27, 27)];
        [imageView_zengyabeng setImage:[UIImage imageNamed:@"zengyabeng_on"]];
        [self addSubview:imageView_zengyabeng];
        
        imageView_EH2 = [[UIImageView alloc] initWithFrame:CGRectMake(41, 75, 27, 27)];
        ...
        imageView_E2 = [[UIImageView alloc] initWithFrame:CGRectMake(41, 128, 27, 27)];
        ...
        imageView_T4 = [[UIImageView alloc] initWithFrame:CGRectMake(41, 197, 27, 27)];
        [imageView_T4 setImage:[UIImage imageNamed:[NSString stringWithFormat:@"xunhuanbeng_%@", [self statusBysName:@"P1_P"]]]];
        [self addSubview:imageView_T4];
        
        imageView_EH1 = [[UIImageView alloc] initWithFrame:CGRectMake(41, 349, 27, 27)];
