...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [backGroungView setImage:[UIImage imageNamed:@"906-2VBG"]];
        [self addSubview:backGroungView];
        
        imageView_T5 = [[UIImageView alloc] initWithFrame:CGRectMake(177, 430, 42, 42)];
        [imageView_T5 setImage:[UIImage imageNamed:@"wenxiang"]];
        [self addSubview:imageView_T5];
        
        imageView_TX = [[UIImageView alloc] initWithFrame:CGRectMake(102, 430, 42, 42)];
        ...
        imageView_EH4 = [[UIImageView alloc] initWithFrame:CGRectMake(285, 291, 27, 27)];
//        [imageView_X1 setImage:[UIImage imageNamed:@"EH2_on"]];
        ...
        imageView_EH3 = [[UIImageView alloc] initWithFrame:CGRectMake(224, 291, 27, 27)];
...
//        [self addSubview:imageView_EH3];
        ...
        imageView_T1 = [[UIImageView alloc] initWithFrame:CGRectMake(252, 78, 27, 27)];
        ...
        imageView_P1 = [[UIImageView alloc] initWithFrame:CGRectMake(143, 78, 27, 27)];
        [self addSubview:imageView_P1];
        imageView_EH2 = [[UIImageView alloc] initWithFrame:CGRectMake(94, 78, 27, 27)];
...
//        [W1_Slabel setBackgroundColor:[UIColor blueColor]];
...
//        [T1_Slabel setTextAlignment:NSTextAlignmentRight];
