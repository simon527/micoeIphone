...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [backGroungView setImage:[UIImage imageNamed:@"903-II-VBG"]];
        [self addSubview:backGroungView];
       
        imageView_qiufa1 = [[UIImageView alloc] initWithFrame:CGRectMake(275, 78, 27, 27)];
        [imageView_qiufa1 setImage:[UIImage imageNamed:@"qiufa_on"]];
        [self addSubview:imageView_qiufa1];
        
        imageView_danxiangfa1 = [[UIImageView alloc] initWithFrame:CGRectMake(275, 183, 27, 27)];
        [imageView_danxiangfa1 setImage:[UIImage imageNamed:@"danxiangfa_on"]];
        [self addSubview:imageView_danxiangfa1];
        
        imageView_EH2 = [[UIImageView alloc] initWithFrame:CGRectMake(251, 234, 27, 27)];
        ...
        imageView_T1 = [[UIImageView alloc] initWithFrame:CGRectMake(208, 87, 27, 27)];
        [imageView_T1 setImage:[UIImage imageNamed:@"paiqifa_on"]];
        [self addSubview:imageView_T1];
        
        imageView_E1 = [[UIImageView alloc] initWithFrame:CGRectMake(221, 196, 27, 27)];
        ...
        imageView_E2 = [[UIImageView alloc] initWithFrame:CGRectMake(221, 321, 27, 27)];
        ...
        imageView_T3 = [[UIImageView alloc] initWithFrame:CGRectMake(132, 72, 57, 57)];
        [imageView_T3 setImage:[UIImage imageNamed:@"jireqi"]];
        [self addSubview:imageView_T3];
        
        imageView_T2 = [[UIImageView alloc] initWithFrame:CGRectMake(110, 144, 100, 100)];
        [imageView_T2 setImage:[UIImage imageNamed:@"shuixiang1"]];
        [self addSubview:imageView_T2];
        
        imageView_P4 = [[UIImageView alloc] initWithFrame:CGRectMake(147, 258, 27, 27)];
        ...
        imageView_T4 = [[UIImageView alloc] initWithFrame:CGRectMake(110, 300, 100, 100)];
        [imageView_T4 setImage:[UIImage imageNamed:@"shuixiang2"]];
        [self addSubview:imageView_T4];
        
        imageView_T5 = [[UIImageView alloc] initWithFrame:CGRectMake(132, 416, 57, 57)];
        [imageView_T5 setImage:[UIImage imageNamed:@"linyuqi"]];
        [self addSubview:imageView_T5];
        
        imageView_danxiangfa2 = [[UIImageView alloc] initWithFrame:CGRectMake(84, 87, 27, 27)];
        [imageView_danxiangfa2 setImage:[UIImage imageNamed:@"danxiangfa_on"]];
        [self addSubview:imageView_danxiangfa2];
        
        imageView_qiufa2 = [[UIImageView alloc] initWithFrame:CGRectMake(71, 170, 27, 27)];
        [imageView_qiufa2 setImage:[UIImage imageNamed:@"qiufa_on"]];
        [self addSubview:imageView_qiufa2];
        
        imageView_P1 = [[UIImageView alloc] initWithFrame:CGRectMake(42, 128, 27, 27)];
        ...
        imageView_P3 = [[UIImageView alloc] initWithFrame:CGRectMake(42, 258, 27, 27)];
        ...
        imageView_P2 = [[UIImageView alloc] initWithFrame:CGRectMake(42, 388, 27, 27)];
        ...
        imageViewEH1 = [[UIImageView alloc] initWithFrame:CGRectMake(198, 383, 27, 27)];
...
//        [self addSubview:W1_SLabelView];
        ...
        W2_Slabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 20, 35, 25)];
        ...
        [W2_Slabel setFont:[UIFont fontWithName:kFontName size:30]];
        [W2_Slabel setTextAlignment:NSTextAlignmentCenter];
        [W2_SLabelView addSubview:W2_Slabel];
        UILabel *danwei3 = [[UILabel alloc] initWithFrame:CGRectMake(68, 30, 30, 15)];
        danwei3.text = @"%";
        [danwei3 setFont:[UIFont fontWithName:kFontName size:12]];
        [W2_SLabelView addSubview:danwei3];
        
        T2_Slabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 55, 35, 25)];
        T2_Slabel.text = [NSString stringWithFormat:@"%@", [RbtDataOfResponse sharedInstance].num_T2_S];
        [T2_Slabel setFont:[UIFont fontWithName:kFontName size:30]];
        [T2_Slabel setTextAlignment:NSTextAlignmentCenter];
        [W2_SLabelView addSubview:T2_Slabel];
        UILabel *danwei4 = [[UILabel alloc] initWithFrame:CGRectMake(68, 65, 30, 15)];
        danwei4.text = @"℃";
        [danwei4 setFont:[UIFont fontWithName:kFontName size:12]];
...
//        W_S1View.theme.incompletedColor = [UIColor grayColor];
        ...
        [W_S2View setSize:CGSizeMake(115, 115)];
