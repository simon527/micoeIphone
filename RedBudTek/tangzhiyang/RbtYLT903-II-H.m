...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [backGroungView setImage:[UIImage imageNamed:@"903-II-HBG"]];
        [self addSubview:backGroungView];
        
        imageView_qiufa1 = [[UIImageView alloc] initWithFrame:CGRectMake(22, 14, 27, 27)];
        [imageView_qiufa1 setImage:[UIImage imageNamed:@"qiufa_on"]];
        [self addSubview:imageView_qiufa1];
        
        imageView_danxiangfa1 = [[UIImageView alloc] initWithFrame:CGRectMake(153, 14, 27, 27)];
        [imageView_danxiangfa1 setImage:[UIImage imageNamed:@"danxiangfa_on"]];
        [self addSubview:imageView_danxiangfa1];
        
        imageView_EH2 = [[UIImageView alloc] initWithFrame:CGRectMake(203, 42, 27, 27)];
        ...
        imageView_T1 = [[UIImageView alloc] initWithFrame:CGRectMake(36, 85, 27, 27)];
        [imageView_T1 setImage:[UIImage imageNamed:@"paiqifa_on"]];
        [self addSubview:imageView_T1];
        
        imageView_E1 = [[UIImageView alloc] initWithFrame:CGRectMake(164, 72, 27, 27)];
        ...
        imageView_E2 = [[UIImageView alloc] initWithFrame:CGRectMake(290, 72, 27, 27)];
        ...
        imageView_T3 = [[UIImageView alloc] initWithFrame:CGRectMake(21, 131, 57, 57)];
        [imageView_T3 setImage:[UIImage imageNamed:@"jireqi"]];
        [self addSubview:imageView_T3];
        
        imageView_T2 = [[UIImageView alloc] initWithFrame:CGRectMake(114, 110, 100, 100)];
        [imageView_T2 setImage:[UIImage imageNamed:@"shuixiang1"]];
        [self addSubview:imageView_T2];
        
        imageView_P4 = [[UIImageView alloc] initWithFrame:CGRectMake(227, 146, 27, 27)];
        ...
        imageView_T4 = [[UIImageView alloc] initWithFrame:CGRectMake(269, 110, 100, 100)];
        [imageView_T4 setImage:[UIImage imageNamed:@"shuixiang2"]];
        [self addSubview:imageView_T4];
        
        imageView_T5 = [[UIImageView alloc] initWithFrame:CGRectMake(407, 131, 57, 57)];
        [imageView_T5 setImage:[UIImage imageNamed:@"linyuqi"]];
        [self addSubview:imageView_T5];
        
        imageView_danxiangfa2 = [[UIImageView alloc] initWithFrame:CGRectMake(36, 209, 27, 27)];
        [imageView_danxiangfa2 setImage:[UIImage imageNamed:@"danxiangfa_on"]];
        [self addSubview:imageView_danxiangfa2];
        
        imageView_qiufa2 = [[UIImageView alloc] initWithFrame:CGRectMake(139, 222, 27, 27)];
        [imageView_qiufa2 setImage:[UIImage imageNamed:@"qiufa_on"]];
        [self addSubview:imageView_qiufa2];
        
        imageView_P1 = [[UIImageView alloc] initWithFrame:CGRectMake(89, 251, 27, 27)];
        ...
        imageView_P3 = [[UIImageView alloc] initWithFrame:CGRectMake(227, 251, 27, 27)];
        ...
        imageView_P2 = [[UIImageView alloc] initWithFrame:CGRectMake(371, 251, 27, 27)];
        ...
        imageViewEH1 = [[UIImageView alloc] initWithFrame:CGRectMake(357, 194, 27, 27)];
