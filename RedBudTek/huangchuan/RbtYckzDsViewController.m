...
- (void)viewDidLoad
{
    ...
    for (int i = 0; i<3; i++) {
        UILabel *lab1 = [[UILabel alloc] initWithFrame:CGRectMake(10, 80+space*i, 50, 30)];
        ...
        UILabel *labks = [[UILabel alloc] initWithFrame:CGRectMake(10, 105+space*i, 45, 30)];
        labks.text = @"开始";
        ...
        timePicker.frame = CGRectMake(55, 40+space*i, 90, 162);
        [timePicker setShowsSelectionIndicator:YES];
        [self.view addSubview:timePicker];
        timePicker.tag = i*100+1;
        
        UILabel *labjs = [[UILabel alloc] initWithFrame:CGRectMake(170, 105+space*i, 45, 30)];
        labjs.text = @"结束";
        ...
        timePicker_j.frame = CGRectMake(200, 40+space*i, 90, 162);
