...
@interface RbtLoginWaitViewController ()

@end

@implementation RbtLoginWaitViewController
...
- (void)viewDidLoad
{
    ...
    self.title = @"欢迎登录";
    UIImageView *imgv_bg = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"loginWait_bg"]];
    imgv_bg.frame = CGRectMake((ScreenWidth-284)/2, (ScreenHeight-280)/2, 284, 280);
    [self.view addSubview:imgv_bg];
    
    UILabel *lab_welcome = [[UILabel alloc] initWithFrame:CGRectMake(35, (ScreenHeight-280)/2+10, 250, 40)];
    lab_welcome.text = [NSString stringWithFormat:@"尊敬的%@用户，欢迎登入！",[RbtUserModel sharedInstance].ut];    
    [lab_welcome setFont:[UIFont fontWithName:kFontName size:16]];
    lab_welcome.textColor = [UIColor colorWithRed:0.0 green:147/255.0 blue:221/255.0 alpha:1];
    [self.view addSubview:lab_welcome];

    UILabel *lab_timeTou = [[UILabel alloc] initWithFrame:CGRectMake(35, (ScreenHeight-280)/2+60, 250, 30)];
    lab_timeTou.text = @"您上次登录时间为";
    [lab_timeTou setFont:[UIFont fontWithName:kFontName size:13]];
    lab_timeTou.textColor = [UIColor colorWithRed:25/255.0 green:25/255.0 blue:25/255.0 alpha:1];
    [self.view addSubview:lab_timeTou];
    
    UILabel *lab_time = [[UILabel alloc] initWithFrame:CGRectMake(35, (ScreenHeight-280)/2+80, 250, 30)];
    ...
    [lab_time setFont:[UIFont fontWithName:kFontName size:13]];
    lab_time.textColor = [UIColor colorWithRed:25/255.0 green:25/255.0 blue:25/255.0 alpha:1];
    [self.view addSubview:lab_time];
    
    UILabel *lab_info = [[UILabel alloc] initWithFrame:CGRectMake(35, (ScreenHeight-280)/2+120, 250, 30)];
    lab_info.text = @"请您根据需求选择下列操作：";
    [lab_info setFont:[UIFont fontWithName:kFontName size:13]];
    lab_info.textColor = [UIColor colorWithRed:25/255.0 green:25/255.0 blue:25/255.0 alpha:1];
    [self.view addSubview:lab_info];
    
    UIButton *btn_history = [UIButton buttonWithType:UIButtonTypeCustom];
    ...
    btn_history.frame = CGRectMake((ScreenWidth-267)/2, (ScreenHeight-280)/2+160, 267, 40);
    btn_search.frame = CGRectMake((ScreenWidth-267)/2, (ScreenHeight-280)/2+210, 267, 40);
