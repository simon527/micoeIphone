...
@implementation micYLT903_II

@synthesize backGroungView, imageView_danxiangfa1, imageView_danxiangfa2, imageView_E1, imageView_E2, imageView_EH2, imageView_P1, imageView_P2, imageView_P3, imageView_P4, imageView_qiufa1, imageView_qiufa2, imageView_T1, imageView_T2, imageView_T3, imageView_T4, imageView_T5, imageViewEH1;

- (id)initWithFrame:(CGRect)frame
{
    self = [[[NSBundle mainBundle] loadNibNamed:@"micYLT903-II" owner:self options:nil] objectAtIndex:0];
    if (self) {
        // Initialization code
       
        
//        backGroungView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 768, 1024-194-49)];
