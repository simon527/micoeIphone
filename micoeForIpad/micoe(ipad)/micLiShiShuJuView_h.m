...
@implementation micLiShiShuJuView_h
...
//    float gap3 = self.height － 94 －49 －130;
    float gap3 = self.height - 230- 20;
    
    float tableViewHeight = gap3-gap2-60-20;
    
    UIImageView *topImageView = [[UIImageView alloc] initWithFrame:CGRectMake(gap1, gap2, self.width-(gap1*2), 60)];
    ...
    [lbBtn setFrame:CGRectMake(self.width - 93, gap2+15, 29, 29)];
    ...
    [xxtBtn setFrame:CGRectMake(self.width - 53, gap2+15, 29, 29)];
    ...
    UIImageView *imageView_downBG = [[UIImageView alloc] initWithFrame:CGRectMake(gap1, gap3, topImageView.width, 230)];
...
//    float gap6 = (topImageView.width - 138*4)/8;
    ...
    for (int i=0; i < shebeiCount; i++) {
        ...
        btnX += 2*gap4 + 138;
        UIImageView *shadowImageView = [[UIImageView alloc] initWithFrame:CGRectMake((138 + gap4*2)*i, cLabel.origin.y+cLabel.height-5, 252, 6)];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        ...
        cell.height = dataTabelView.height/4;
