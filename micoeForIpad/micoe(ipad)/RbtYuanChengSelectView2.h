...
@class RbtYuanChengSelectView2;

@protocol RbtYuanChengSelectViewDelegate2 <NSObject>
- (void)buttonAcitons: (NSInteger) thebutton andView:(RbtYuanChengSelectView2 *)theView;
@end

@interface RbtYuanChengSelectView2 : UIView
{
    UIButton *btn1;
    UIButton *btn2;
    UIButton *btn3;
