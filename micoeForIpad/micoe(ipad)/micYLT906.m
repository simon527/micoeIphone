...
@implementation micYLT906

@synthesize imageView_P3, imageView_linyuqi, imageView_EH2, imageView_T5, imageView_T4, imageView_T2, imageView_P2, imageView_EH4, imageView_EH3, imageView_T3, imageView_DDF1, imageView_DDF2, imageView_EH5, imageView_jireqi1, imageView_jireqi2, imageView_jireqi3, imageView_jireqi4, imageView_P1_1, imageView_P1_2, imageView_P1_3, imageView_P1_4, imageView_P41, imageView_P42, imageView_P51, imageView_P52, imageView_qiufa, imageView_T1_1, imageView_T1_2, imageView_T1_3, imageView_T1_4, imageView_T6, imageView_X1, imageView_X2;

- (id)initWithFrame:(CGRect)frame
{
    self = [[[NSBundle mainBundle] loadNibNamed:@"micYLT903-II" owner:self options:nil] objectAtIndex:3];
    if (self) {
        // Initialization code
