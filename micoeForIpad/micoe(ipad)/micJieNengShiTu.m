...
@implementation micJieNengShiTu
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIImageView *upImageView = [[UIImageView alloc] initWithFrame:CGRectMake(sideGap, gap1, 750, 388)];
        [upImageView setImage:[UIImage imageNamed:@"jnst_shangImage"]];
        [self addSubview:upImageView];
        
        UIImageView *downImageView = [[UIImageView alloc] initWithFrame:CGRectMake(sideGap, gap1+upImageView.height+gap2, 750, 268)];
        [downImageView setImage:[UIImage imageNamed:@"jnst_xiaImage"]];
        [self addSubview:downImageView];
        
        float timeButtonGap = (750-164-167-157)/2;
        
        btn_week = [UIButton buttonWithType:UIButtonTypeCustom];
        [btn_week setTag:4010];
        [btn_week setFrame:CGRectMake(timeButtonGap, gap1+17, 164, 37)];
        ...
        [btn_month setFrame:CGRectMake(timeButtonGap+164, gap1+17, 167, 37)];
        ...
        [btn_year setFrame:CGRectMake(timeButtonGap+164+167, gap1+17, 164, 37)];
        ...
        titleLbel = [[UILabel alloc] initWithFrame:CGRectMake(300, gap1+115, 250, 50)];
        ...
        showLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, gap1+185, 470, 120)];
        ...
        unitLabel = [[UILabel alloc] initWithFrame:CGRectMake(490, gap1+250, 80, 40)];
        unitLabel.text = @"吨";
