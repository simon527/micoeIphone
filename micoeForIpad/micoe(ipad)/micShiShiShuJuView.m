...
@implementation micShiShiShuJuView
...
//        self.backgroundColor = [UIColor redColor];
        ...
        UIImageView *bgImageView = [[UIImageView alloc] initWithFrame:CGRectMake(8, 0, 752, 766)];
        [bgImageView setImage:[UIImage imageNamed:@"sssj_bg"]];
        [self addSubview:bgImageView];
        
        UILabel *timeLabel = [[UILabel alloc] initWithFrame:CGRectMake((768-300)/2, 4, 300, 40)];
        ...
        gap1 = (self.width -10 - imageWidth*4)/8;
        gap2 = (self.height - 80 - imageHeight*3 - 20)/3 ;
        imageX = gap1;
        imageY = 50;
...
-(void)fresh
{
    ...
    imageX = (self.width -10 - imageWidth*4)/8;
    imageY = 50;
...
-(void)arrangeImageByArray:(NSMutableArray *)array withtag:(NSInteger)imageTag
{
    ...
    if (array.count) {
        for (NSDictionary *dic in array) {
            ...
            int j = imageIndex/12;
            int k = (imageIndex%12)/4;
            if ((imageIndex%4 == 0) && (imageIndex%12 != 0) ) {
                imageX = (self.width -10 - imageWidth*4)/8 + (self.width-10)*j;
                imageY =50 + (imageHeight + gap2)*k;
            }
