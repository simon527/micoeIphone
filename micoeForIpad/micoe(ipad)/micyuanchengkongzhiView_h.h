...
@interface micyuanchengkongzhiView_h : micWDGCView<RbtYuanChengSelectViewDelegate, RbtSheBeiViewDelegate,RbtDsDelegate,RbtYuanChengSelectViewDelegate2>
{
...
@property(strong,nonatomic) RbtYuanChengSelectView2_h *ssSelectView;
@property(strong,nonatomic) RbtYuanChengSelectView2_h *jrSelectView;
