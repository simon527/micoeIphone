...
@implementation micYLT906_2

@synthesize imageView_T1_4, imageView_T1_3, imageView_T1_2, imageView_qiufa, imageView_P52, imageView_P51, imageView_P42, imageView_P41, imageView_P1_4, imageView_P1_3, imageView_P1_2, imageView_jireqi4, imageView_jireqi3, imageView_jireqi2, imageView_jireqi1, imageView_DDF2, imageView_DDF1, imageView_T3, imageView_EH3, imageView_EH4, imageView_P2, imageView_T2, imageView_T4, imageView_T5, imageView_EH2, imageView_linyuqi, imageView_P3, imageView_T1, imageView_P1, imageView_TX;

- (id)initWithFrame:(CGRect)frame
{
     self = [[[NSBundle mainBundle] loadNibNamed:@"micYLT903-II" owner:self options:nil] objectAtIndex:4];
    if (self) {
        // Initialization code
        float topgap = 130+20+44;
        
        UIImageView *backGroungView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 768, 1024-194-49)];
        [backGroungView setImage:[UIImage imageNamed:@"906-02bg"]];
        [self addSubview:backGroungView];
        
        imageView_T5 = [[UIImageView alloc] initWithFrame:CGRectMake(429, 876-topgap, 74, 74)];
        [imageView_T5 setImage:[UIImage imageNamed:@"wenxiang"]];
        [self addSubview:imageView_T5];
        
        imageView_TX = [[UIImageView alloc] initWithFrame:CGRectMake(264, 876-topgap, 74, 74)];
        ...
        imageView_EH4 = [[UIImageView alloc] initWithFrame:CGRectMake(673, 619-topgap, 51, 51)];
        ...
        imageView_EH3 = [[UIImageView alloc] initWithFrame:CGRectMake(513, 619-topgap, 51, 51)];
        ...
        imageView_T1 = [[UIImageView alloc] initWithFrame:CGRectMake(615, 227-topgap, 51, 51)];
        ...
        imageView_P1 = [[UIImageView alloc] initWithFrame:CGRectMake(353, 227-topgap, 51, 51)];
...
-(void)setStatus
{
    ...
    [imageView_P1_4 setImage:[UIImage imageNamed:[NSString stringWithFormat:@"xunhuanbeng_%@", [self statusBysName:@"P1_4_P"]]]];
    //    [imageView_EH5 setImage:[UIImage imageNamed:[NSString stringWithFormat:@"EH2_%@", [self statusBysName:@"EH5"]]]];
    [imageView_P1_3 setImage:[UIImage imageNamed:[NSString stringWithFormat:@"xunhuanbeng_%@", [self statusBysName:@"P1_3_P"]]]];
    [imageView_EH4 setImage:[UIImage imageNamed:[NSString stringWithFormat:@"EH2_%@", [self statusBysName:@"EH4_EH"]]]];
    [imageView_P1_2 setImage:[UIImage imageNamed:[NSString stringWithFormat:@"xunhuanbeng_%@", [self statusBysName:@"P1_2_P"]]]];
